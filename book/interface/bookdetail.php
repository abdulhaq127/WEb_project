...
<!--start bookdetails-->
 <div class="box-content">
               <form method="POST" action="../data/class.post_curd.php">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: center;"><input type="submit" class="btn btn-primary" name="submit" value="Stor" ></td>
                            </tr>
