...
$result = mysqli_query($mysqli, "SELECT * FROM author ORDER BY author_id DESC"); // using mysqli_query instead
?>
...
<a href="add.html">Add New Data</a><br/><br/>
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a href=\"edit.php?id=$res[author_id]\">Edit</a> | <a href=\"delete.php?id=$res[author_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
